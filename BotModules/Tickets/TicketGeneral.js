...
const TicketGeneralModel = new ModalBuilder().setCustomId(`general-ticket`).setTitle(`Create General Ticket`).addComponents([
...
module.exports = {
    ...
    {
        await buttonInteraction.showModal(TicketGeneralModel);
        return;
    },
